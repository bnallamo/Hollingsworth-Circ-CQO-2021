/************************************************************
FILENAME: cabg20_020.sas
AUTHOR: skaufman
DATE: 5/18/2017
ID: 54
SUMMARY: MEDPAR COMBINED FILE.  
************************************************************/

proc sort data=cabg20.cabg08_14_v14(keep=bene_id sadmsndt sdschrgdt dob
        cabg_dt rename=(sadmsndt=sadmsndt_coh sdschrgdt=sdschrgdt_coh)) out=cohort nodupkey;
   by bene_id;
run;
...
data cabg20.medp08_14(drop=DSCHRG_DSTNTN_CD);
   length sadmsndt 5;
   set
      med.med08p20(in=a keep=BENE_ID sadmsndt DGNS_CD: PRCDR_CD: SSLSSNF sdschrgdt prcdr_dt:
          prvnumgrp dstntncd SRC_ADMS drg_cd LOSCNT TYPE_ADM zipcode RACE SEX er_amt)
      med.med09p20(in=b keep=BENE_ID sadmsndt DGNS_CD: PRCDR_CD: SSLSSNF sdschrgdt prcdr_dt:
          prvnumgrp dstntncd SRC_ADMS drg_cd LOSCNT TYPE_ADM zipcode RACE SEX er_amt)
      med.med10p20(in=c keep=BENE_ID sadmsndt DGNS_CD: PRCDR_CD: SSLSSNF sdschrgdt prcdr_dt:
         prvnumgrp dstntncd SRC_ADMS drg_cd LOSCNT TYPE_ADM zipcode RACE SEX er_amt)
      med.med11p20(in=d keep=BENE_ID sadmsndt DGNSCD1-DGNSCD25 PRCDRCD1-PRCDRCD25 SSLSSNF sdschrgdt
                 PRCDRDT1-PRCDRDT25 prvnumgrp dstntncd SRC_ADMS drg_cd LOSCNT TYPE_ADM BENE_ZIP RACE SEX
                 er_amt
                rename=(DGNSCD1-DGNSCD25=DGNS_CD1-DGNS_cd25 PRCDRDT1-PRCDRDT25=prcdr_dt1-prcdr_dt25
            PRCDRCD1-PRCDRCD25=PRCDR_CD1-PRCDR_CD25 BENE_ZIP=zipcode))
      med.med12p20(in=e keep=BENE_ID sadmsndt DGNS_CD1-DGNS_CD25 PRCDR_CD1-PRCDR_CD25 SS_LS_SNF_IND_CD
                PRCDR_DT1-PRCDR_DT25 sdschrgdt prvnumgrp DSCHRG_DSTNTN_CD SRC_IP_ADMSN_CD drg_cd
                LOS_DAY_CNT IP_ADMSN_TYPE_CD MLG_CNTCT_ZIP_CD RACE_CD SEX_CD ER_CHRG_AMT
                rename=(SS_LS_SNF_IND_CD=SSLSSNF PRCDR_DT1-PRCDR_DT25=prcdr_dt1-prcdr_dt25
                  SRC_IP_ADMSN_CD=SRC_ADMS LOS_DAY_CNT=LOSCNT IP_ADMSN_TYPE_CD=TYPE_ADM MLG_CNTCT_ZIP_CD=zipcode
                  RACE_CD=RACE SEX_CD=SEX ER_CHRG_AMT=er_amt))
      med.med13p20(in=f keep=BENE_ID sadmsndt prvnumgrp DSCHRG_DSTNTN_CD SRC_IP_ADMSN_CD drg_cd
                ...
                LOS_DAY_CNT IP_ADMSN_TYPE_CD BENE_MLG_CNTCT_ZIP_CD BENE_RACE_CD BENE_SEX_CD ER_CHRG_AMT
                rename=(
                  BENE_MLG_CNTCT_ZIP_CD=zipcode BENE_RACE_CD=RACE BENE_SEX_CD=SEX
                  SRC_IP_ADMSN_CD=SRC_ADMS LOS_DAY_CNT=LOSCNT IP_ADMSN_TYPE_CD=TYPE_ADM
                  SS_LS_SNF_IND_CD=SSLSSNF ER_CHRG_AMT=er_amt
      ...
      med.med14p20(in=g keep=BENE_ID sadmsndt prvnumgrp DSCHRG_DSTNTN_CD SRC_IP_ADMSN_CD
                drg_cd DGNS_1_CD--DGNS_25_CD
                SRGCL_PRCDR_1_CD--SRGCL_PRCDR_25_CD SS_LS_SNF_IND_CD sdschrgdt
                SRGCL_PRCDR_PRFRM_1_DT--SRGCL_PRCDR_PRFRM_25_DT
                LOS_DAY_CNT IP_ADMSN_TYPE_CD BENE_MLG_CNTCT_ZIP_CD BENE_RACE_CD BENE_SEX_CD ER_CHRG_AMT
                rename=(
                  ...
                  ;
   if e or f or g then dstntncd=DSCHRG_DSTNTN_CD+0;
run;

options varlenchk=warn;

%sortdata2(cabg20.medp08_14, bene_id)

data cabg20.medp08_14;
   merge
      cohort(in=a)
      cabg20.medp08_14
      ;
